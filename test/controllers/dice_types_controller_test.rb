...
class DiceTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dice_type" do
    assert_difference("DiceType.count") do
      post dice_types_url, params: { dice_type: { name: @dice_type.name, position: @dice_type.position, sides: @dice_type.sides } }
    end
  ...
  test "should update dice_type" do
    patch dice_type_url(@dice_type), params: { dice_type: { name: @dice_type.name, position: @dice_type.position, sides: @dice_type.sides } }
